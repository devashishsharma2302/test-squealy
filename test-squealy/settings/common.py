...
"""
Django settings for test-squealy project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '+n+cn@6rcj1h#3jxvdtw*d((tn!dw5%-i^ws+q*xj54nz*62a0')
...
ROOT_URLCONF = 'test-squealy.urls'
...
WSGI_APPLICATION = 'test-squealy.wsgi.application'
...
# See .ebextensions/test-squealy.config
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'when': 'midnight',
            'backupCount': 10,
            'filename': os.path.join(LOG_DIR, 'test-squealy.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
